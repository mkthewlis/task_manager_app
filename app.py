...
#Once you edit a category, redirected to editcategory page
...
#Updates category once it's been edited
...
#No need for an id here yet as it doesn't exist (we are creating it now!)
